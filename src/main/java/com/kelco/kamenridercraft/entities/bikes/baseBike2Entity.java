...
public class baseBike2Entity extends Mob implements GeoEntity {
    ...
    public baseBike2Entity(EntityType<? extends Mob> entityType, Level level, Item drop) {
        ...
        if (this.isAlive()) {
            ...
            if (this.isVehicle()) {
                ...
                if (passenger != null) {
                    ...
                    if (zInput > 0) {
                        if (this.getSpeed() < 0.2) this.setSpeed(this.getSpeed() + MAX_SPEED);
                        ...
                        if (this.getSpeed() < 0.15) this.setSpeed(this.getSpeed() + MAX_SPEED);
                        setYRot(yRotO + passenger.xxa * 10F);
                        setXRot(-passenger.getXRot() * 3f);
