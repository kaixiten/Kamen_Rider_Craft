...
public class KamenRiderCraftCore
{
    ...
    public static class ClientModEvents
    {
        ...
        public static void entityRenderers(EntityRenderersEvent.RegisterRenderers event) {
            ...
            event.registerEntityRenderer(MobsCore.BICYCLE.get(), Bike2Renderer::new);
            ...
            event.registerEntityRenderer(MobsCore.PROTO_SPORTS_GAMER.get(), Bike2Renderer::new);
            ...
            event.registerEntityRenderer(MobsCore.VICE_BIKE.get(), Bike2Renderer::new);
